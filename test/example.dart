...
main() {
  ...
  test('colamd', () {
    ...
    final AA = new Int32List.fromList([
    ...
    final p = new Int32List.fromList([
    ...
    final B = new Int32List.fromList([		/* Note: only strictly lower triangular part */
    ...
    final q = new Int32List.fromList([
